...
|<<metricbeat-module-slurm,slurm>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.2+| .2+|  |<<metricbeat-metricset-slurm-job_cpu,job_cpu>> beta[]  
|<<metricbeat-metricset-slurm-job_mem,job_mem>> beta[]  
...
include::modules/slurm.asciidoc[]
