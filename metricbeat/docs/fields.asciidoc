...
slurm module contains metrics for memory and cpu usage of jobs
...
job_cpu contains metrics associated with CPU usage of jobs.



*`slurm.job_cpu.job_user`*::
+
--
...
*`slurm.job_cpu.cpuutil`*::
+
--
CPU utilization of job
...
job_mem contains metrics associated with memory usage of jobs.



*`slurm.job_mem.job_user`*::
+
--
Username associated with job
...
*`slurm.job_mem.memreq`*::
+
--
maximum amount of memory for job
